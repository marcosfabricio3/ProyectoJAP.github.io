...
const URL = `https://japceibal.github.io/emercado-api/products/${localStorage.getItem('identificador del producto')}.json`
    ...
    .then(data => {
      ...
      function showResult(data){
        ...
        document.getElementById("imagenesDelProducto").innerHTML += elementoActivo;
        for (let i = 1; i<= data.images.length; i++){ 
          ...
          document.getElementById("imagenesDelProducto").innerHTML += elementHTML;
        }
    }
    ...
    //Insercion de Comentarios Previos
     ...
     <div class="row">
       <div class="col"><p class="text-break"> ${data2[i].description}</p></div>
     </div>
     <div class="row">
       <div class="col">
...
function comentar(){
    ...
    if(estrellas == 1){
     ...
     let textComentarios = `<div class="text-bg-light p-3 border border-secondary rounded-start">
     <div class="row">
       <div class="col"><p class="text-break"> ${input.value}</p></div>
     </div>
     <div class="row">
       <div class="col">
